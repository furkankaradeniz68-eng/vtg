...
export const metadata: Metadata = { title: "Ausführungskosten/A1 (Haushaltsjahr) | VTG Rheinland-Pfalz" };

export default async function AusfuehrungskostenA1HaushaltsjahrPage({
  searchParams,
}: {
